...
# How get URI of NFT:
Go to https://nft.storage/files/, upload image, then write a metadata file to describe it. The template can be found in transactionTest/assets. Finally, upload metadata file